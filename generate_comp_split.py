...
for caption_type in caption_types:
    for model_type in model_types:
        caption_fp = f'./caption_datasets/{caption_type}/{model_type}/id_captions.json'
        with open(caption_fp, 'r') as f:
            caption_data = json.load(f)
        for attr in attrs:
            print(f'{caption_type}, {model_type}, {attr}')

            pickle_root = f'pickles/{caption_type}/{model_type}/{attr}'

            with open(f'clip_r_attrs/{attr}.txt', 'r') as f:
